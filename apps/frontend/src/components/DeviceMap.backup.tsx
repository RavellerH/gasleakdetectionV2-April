        ...
        {popupDevice && (
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: '15px', fontWeight: 600, marginBottom: 12, fontFamily: "'DM Sans', sans-serif" }}>
                {popupDevice.name}
              </div>
              ...
              {popupDevice.type === 'SENSOR' && (
                <div style={{ marginBottom: 12, padding: '10px', borderRadius: '8px', background: (popupDevice.latestPpm || 0) > (warningThreshold || 50) ? 'rgba(239, 68, 68, 0.1)' : 'rgba(34, 211, 238, 0.05)', border: `1px solid ${(popupDevice.latestPpm || 0) > (warningThreshold || 50) ? 'rgba(239, 68, 68, 0.2)' : 'rgba(34, 211, 238, 0.1)'}` }}>
                  ...
                  <div style={{ fontSize: '18px', fontWeight: 800, color: (popupDevice.latestPpm || 0) > (warningThreshold || 50) ? '#ef4444' : '#22d3ee', fontFamily: "'Geist Mono', monospace", marginTop: 2 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', padding: '10px 0', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                <div>
                  ...
                  <div style={{ fontSize: '13px', fontWeight: 700, color: popupDevice.battery.soc > 20 ? '#f8fafc' : '#ef4444', fontFamily: "'Geist Mono', monospace" }}>
                    {popupDevice.battery.soc}%
                  </div>
                </div>
                <div>
                  <div style={{ fontSize: '9px', color: '#94a3b8', marginBottom: 2 }}>SIGNAL</div>
                  <div style={{ fontSize: '13px', fontWeight: 700, color: '#38bdf8', fontFamily: "'Geist Mono', monospace" }}>
              ...
              <div style={{ marginTop: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontSize: '10px', color: '#64748b', fontFamily: "'Geist Mono', monospace" }}>
