...
Run the same script again any time to restart — it checks for updates first, then skips setup and launches straight away. The script also checks your internet connection and PC specs before setting up. See the [Usage Guide](./Documentation/Usage-Guide.md) for details.
